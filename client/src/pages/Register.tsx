    ...
    return (
        <div className="min-h-screen flex items-center justify-center -mt-20 px-4">
            <div className="glass-panel max-w-md w-full p-8 relative overflow-hidden">
                <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-brand-cyan to-brand-purple"></div>
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Join NanoScope AI for advanced image analysis</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-gradient-to-r from-brand-cyan to-brand-purple hover:from-brand-cyan/80 hover:to-brand-purple/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-cyan focus:ring-offset-gray-900 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                    >
                ...
                <div className="mt-6 text-center text-sm text-gray-400">
                    ...
                    <Link to="/login" className="font-medium text-brand-cyan hover:text-brand-cyan/80 transition-colors">
                        Sign in
                    </Link>
                </div>
            </div>
