                ...
                <header className="h-16 shrink-0 flex items-center justify-between px-8 glass-panel-subtle mb-4 relative z-50">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative group cursor-pointer">
                            <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-brand-indigo to-brand-purple flex items-center justify-center text-sm font-medium text-white shadow-lg border border-white/20 transition-transform group-hover:scale-105">
                            ...
                            <div className="absolute right-0 top-full mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[100]">
                                <div className="glass-panel p-1 border border-brand-cyan/20 shadow-2xl rounded-xl flex flex-col">
                                    ...
                                    <div className="px-4 py-3 border-b border-white/10">
                                        ...
                                        <p className="text-sm text-brand-indigo font-bold capitalize">{user?.plan || 'Trial'}</p>
                                    </div>
                                    <div className="p-1">
